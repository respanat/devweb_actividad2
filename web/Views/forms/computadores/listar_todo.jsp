...
<body>
    <div class="container mt-4">
        ...
        <p><a href="<%= request.getContextPath() %>/computadores/agregar" class="btn btn-success">Agregar Nuevo Computador</a>
           <a href="<%= request.getContextPath() %>/computadores/buscar" class="btn btn-info ml-2">Buscar Computador</a></p>

        <c:if test="${not empty computadores}">
