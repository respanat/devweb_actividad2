...
public class Computador {
    ...
    public Computador(int id, String marca, String categoria, String marcaCpu, double velocidadCpU, String tecnologiaRam, int capacidadRam, String tecnologiaDisco, int capacidadDisco, int numPuertosUSB, int numPuertosHDMI, String marcaMonitor, double pulgadas, double precio, Integer usuario_id) {
        this.id = id;
        this.marca = marca;
    ...
    public Computador(String marca, String categoria, String marcaCpu, double velocidadCpU, String tecnologiaRam, int capacidadRam, String tecnologiaDisco, int capacidadDisco, int numPuertosUSB, int numPuertosHDMI, String marcaMonitor, double pulgadas, double precio, Integer usuario_id) {
        this.marca = marca;
        this.categoria = categoria;
        this.marcaCpu = marcaCpu;
        this.velocidadCpU = velocidadCpU;
